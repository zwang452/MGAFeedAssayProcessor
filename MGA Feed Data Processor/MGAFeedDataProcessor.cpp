...
void help() {
	cout << endl << "Auto Processor and report generator for MGA Feed Assay" << endl << endl
		...
		<< "Excel file will be generated under the same directory with name format inputFileName + CurrentDate + xls." << endl
		<< "File with same name under the directory "
		<< "will be overwritten." << endl << endl
		<< "source code of the program can be found under" << endl
